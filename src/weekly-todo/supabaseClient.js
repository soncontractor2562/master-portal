...
const supabaseUrl = import.meta.env.VITE_WEEKLY_TODO_SUPABASE_URL || defaultUrl;
const supabaseAnonKey = import.meta.env.VITE_WEEKLY_TODO_SUPABASE_ANON_KEY || defaultKey;
