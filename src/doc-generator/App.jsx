          ...
          <div className="report-header">
            <div className="header-top">
              ...
              <div className="header-title">
                ...
                <div className="doc-sub-title">รายงานประจำวัน</div>
              </div>
            </div>
    ...
    <div className="app">
      <div className="topbar no-print">
        <div style={{ display: 'flex', alignItems: 'center', gap: '16px', flexWrap: 'wrap' }}>
          <div>
            <h1>Master Portal - Doc Generator</h1>
            <div className="sub">ระบบสร้างรายงานประจำวัน และ ใบขออนุมัติปฏิบัติงานรายวัน</div>
          </div>
