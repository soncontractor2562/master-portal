...
export default function WeeklyTodoView() {
  return (
    ...
    <div className="weekly-todo-root" style={{ flex: 1, overflowY: 'auto', overflowX: 'hidden', overscrollBehavior: 'contain', WebkitOverflowScrolling: 'touch', padding: '0.75rem 1rem' }}>
      <WeeklyTodoApp />
    </div>
  );
}
