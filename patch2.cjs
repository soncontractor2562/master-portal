const fs = require('fs');
let appJs = fs.readFileSync('C:/Users/HP/Desktop/Antigravity/Store Drag&Drop/Store manager V1/JavaScript.html', 'utf8');
...
fs.writeFileSync('C:/Users/HP/Desktop/Antigravity/Store Drag&Drop/Store manager V1/JavaScript.html', appJs);
