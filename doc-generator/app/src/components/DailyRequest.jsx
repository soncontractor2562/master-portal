    ...
    <div className={`a4-page ${themeClass}`}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-around', alignItems: 'flex-start', marginTop: '40px', gap: '20px' }}>
          ...
          <div className="signer-box" style={{ position: 'relative', width: '220px', display: 'flex', flexDirection: 'column', paddingTop: '20px' }}>
            <div style={{ fontWeight: 'bold', fontSize: '13px', marginBottom: '60px' }}>ผู้ขออนุมัติ</div>
            {data.requesterSignature && (
              <img src={data.requesterSignature} alt="signature" style={{ position: 'absolute', top: '35px', left: '50%', transform: 'translateX(-50%)', maxHeight: '55px', maxWidth: '100%', objectFit: 'contain' }} />
            )}
          ...
          {/* Approver */}
          <div className="approver-box" style={{ width: '320px', padding: '20px 24px' }}>
            ...
            <div style={{ fontSize: '11.5px', marginBottom: '40px', lineHeight: '2.2', overflow: 'hidden', whiteSpace: 'nowrap' }}>
               หมายเหตุ: ....................................................................
               <br/>
               ...........................................................................................
            </div>
